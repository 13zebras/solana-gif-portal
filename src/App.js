...
/* 
const TEST_GIFS = [
    "https://media.giphy.com/media/xTdAjr0aZ8PcSAGTqE/giphy.gif",X
    "https://media.giphy.com/media/l41Yzjtm0YbybMLHG/giphy.gif",X
    "https://media.giphy.com/media/10zrR4UzeWa3ja/giphy.gif",X
    "https://media.giphy.com/media/W28xDHXzmkRva2Affn/giphy.gif",X
    "https://media.giphy.com/media/25IFTnS61JZ0A/giphy.gif",X
                    ...
                    <div className="gif-grid">
                        ...
                        {gifList.map((item, index) => (
                            <div className="gif-item" key={index}>
								...
								<span className="gif-user">Submitted by: {item.userAddress.toString()}</span>
                            </div>
                        ))}
                    </div>
                </div>
